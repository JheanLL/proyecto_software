...
export async function modificarCargo(formData: FormData) {
  ...
  // 1. Obtenemos una conexión dedicada del pool
  ...
  try {
    ...
    // 3. Ejecutamos operaciones usando 'connection' en lugar de 'pool'
    ...
    // 5. Si algo falla (auditoría o update), deshacemos todo
    ...
    // 6. ¡IMPORTANTE! Liberamos la conexión para que vuelva al pool
    connection.release();
  }
}
